...
import com.mytaxi.datatransferobject.AssignDriverToCarRequestDTO;
...
public class DriverController
{
    ...
    public CarDTO assignCarToDriver(@Valid @PathVariable long dirverId, @Valid @RequestBody AssignDriverToCarRequestDTO driverToCarDTO ) throws CarAlreadyInUseException, EntityNotFoundException 
    {
        CarDO carDO = carService.SelectCar(dirverId, driverToCarDTO.getCarId());
