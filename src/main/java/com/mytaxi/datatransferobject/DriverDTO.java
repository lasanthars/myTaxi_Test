...
public class DriverDTO
{
    ...
    private DriverDTO(Long id, String username, String password, GeoCoordinate coordinate, String gender)
    {
        this.id = id;
    ...
    public static class DriverDTOBuilder
    {
        ...
        {
            return new DriverDTO(id, username, password, coordinate, gender);
        }
